...
|----------|---------------|
| Jupiter  | [CLI & trading functions guide](https://github.com/muhammad-rabby/solana-trading-cli/blob/main/src/jupiter/README.md) |
| Raydium   | [CLI & trading functions guide](https://github.com/muhammad-rabby/solana-trading-cli/blob/main/src/raydium/README.md) |
| Orca      | [CLI & trading functions guide](https://github.com/muhammad-rabby/solana-trading-cli/blob/main/src/orca/README.md) |
| Meteora   | [CLI & trading functions guide](https://github.com/muhammad-rabby/solana-trading-cli/blob/main/src/meteora/README.md) |
...
[Explore the documentation](https://github.com/muhammad-rabby/solana-trading-cli/blob/main/src/trading_dev/README.md)
...
|----------|----------|--------|
| gRPC Pump.fun Sniper Bot | Ultra-low latency (0.4-2 seconds) | [View source](https://github.com/muhammad-rabby/solana-trading-cli/tree/main/src/grpc_streaming_dev/grpc-pf-sniper) |
| gRPC Copy Bot | Replicate successful trading strategies | [View source](https://github.com/muhammad-rabby/solana-trading-cli/tree/main/src/grpc_streaming_dev/grpc-copy-bot) |
| gRPC Raydium Sniper Bot | Optimized for Raydium DEX | [View source](https://github.com/muhammad-rabby/solana-trading-cli/tree/main/src/grpc_streaming_dev/grpc-raydium-sniper) |
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/muhammad-rabby/solana-trading-cli.git
   ```
